  ...
  class Engagement
    ...
    class << self
      ...
      def find_by_association(association_id, association_type)
        ...
        raise InvalidParams.new("expecting Integer parameter") unless association_id.try(:is_a?, Integer)
        raise InvalidParams.new("expecting String parameter") unless association_type.try(:is_a?, String)
